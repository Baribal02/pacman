...
public class Level2 extends SuperPacmanArea {
    ...
    public void createArea(){
    	...
    	registerActor(new Gate(this,Orientation.RIGHT,new DiscreteCoordinates(10,2),key5));
    	registerActor(new Gate(this,Orientation.RIGHT,new DiscreteCoordinates(19,2),key5));
    	registerActor(new Gate(this,Orientation.RIGHT,new DiscreteCoordinates(12,8),key5));
    	registerActor(new Gate(this,Orientation.RIGHT,new DiscreteCoordinates(17,8),key5));
